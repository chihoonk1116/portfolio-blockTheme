...
/***/ "./src/skillset/components/FlipWords.jsx":
/*!***********************************************!*\
  !*** ./src/skillset/components/FlipWords.jsx ***!
  \***********************************************/
...
/* harmony import */ var _components_FlipWords__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/FlipWords */ "./src/skillset/components/FlipWords.jsx");
...
document.addEventListener("DOMContentLoaded", () => {
  const filpWordsBlocks = document.querySelectorAll('.skillset-root');
  filpWordsBlocks.forEach(el => {
    const words = JSON.parse(el.dataset.words);
    const size = el.dataset.size;
    react_dom__WEBPACK_IMPORTED_MODULE_1___default().render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_components_FlipWords__WEBPACK_IMPORTED_MODULE_3__.FlipWords, {
      words: words,
      className: size
    }), el);
  });
